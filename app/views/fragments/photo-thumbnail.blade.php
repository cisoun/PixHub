...
<div class="photo-thumbnail photo">
	<a href="/photo/{{ $image->id }}" ><img src="{{ $image->path() }}" class="photo-thumbnail-img" class="img-responsive"/></a>
	<div class="photo-thumbnail-overlay">
		<div class="photo-thumbnail-infos">
			<a href="/user/{{ $author->pseudo }}" ><img src="{{ $avatar }}" class="avatar"/></a>
			<div>
				<span class="photo-thumbnail-title"><a href="/photo/{{ $image->$id }}" >{{ $image->name }}</a></span>
