...
class HomeController extends BaseController {
	...
	*/
	...
	{
		return View::make('createusertest'); // ... de test
	}
	...
	public function createUser()
	{
		...
		if ($validator->fails()) {
			return Redirect::to('createusertest')
	...
	{
		// show the form
		return View::make('logintest'); // ... de test
	}
	...
	// validate the info, create rules for the inputs
		...
		// if the validator fails, redirect back to the form
		if ($validator->fails()) {
			return Redirect::to('logintest') // Page de login de test
				->withErrors($validator) // send back all errors to the login form
				->withInput(Input::except('password')); // send back the input (not the password) so that we can repopulate the form
		} else {
			...
			if (Auth::attempt($userdata)) {
				...
				return Redirect::to('tablestest'); // Return sur la page de test de table
	...
	public function doLogout()
	{
		...
		return Redirect::to('logintest'); // redirect the user to the login screen
	}
}
